...
class GeocodingService {
  ...
  // Base de Datos exhaustiva de referencias conocidas (300+ puntos de Villa Brasil, Villa Granada, Alta Vista, Orinokia, San Félix y Upata)
  static final List<PlaceSuggestion> knownDataset = [
    // --- Villa Brasil / Villa Granada / Campo B ---
    PlaceSuggestion(displayName: 'La Caribeña Bodegón (Villa Granada)', location: LatLng(8.314460, -62.726100)),
    PlaceSuggestion(displayName: 'Posada Turística Kaori (Campo B)', location: LatLng(8.313960, -62.725310)),
    PlaceSuggestion(displayName: 'Bloques de Villa Brasil', location: LatLng(8.312390, -62.726660)),
    PlaceSuggestion(displayName: 'C.E.I. Puerto Ordaz (Villa Brasil)', location: LatLng(8.312580, -62.727560)),
    PlaceSuggestion(displayName: 'E.B.N. Puerto Ordaz (Villa Brasil)', location: LatLng(8.312220, -62.727110)),
    PlaceSuggestion(displayName: 'GranosManía (Villa Granada)', location: LatLng(8.316250, -62.727840)),
    PlaceSuggestion(displayName: 'Akahai (Campo B)', location: LatLng(8.315290, -62.723000)),
    PlaceSuggestion(displayName: 'RB9 Comida Rápida (Campo B)', location: LatLng(8.315210, -62.722920)),
    PlaceSuggestion(displayName: 'Fresco Merengadas (Campo B)', location: LatLng(8.315370, -62.722930)),
    PlaceSuggestion(displayName: 'Ciudad Mineros (Campo B)', location: LatLng(8.315120, -62.722840)),
    PlaceSuggestion(displayName: 'Conjunto La Fortaleza (Villa Granada)', location: LatLng(8.313270, -62.731120)),
    PlaceSuggestion(displayName: 'Conjunto Corsica Place (Villa Granada)', location: LatLng(8.316510, -62.730910)),
    PlaceSuggestion(displayName: 'Conjunto Santa Ana (Villa Granada)', location: LatLng(8.317860, -62.730220)),
    PlaceSuggestion(displayName: 'Conjunto Giraluna I (Villa Granada)', location: LatLng(8.314370, -62.731530)),
    PlaceSuggestion(displayName: 'Unidad Clínica Ambulatoria ANFE (Campo B)', location: LatLng(8.314520, -62.720620)),
    PlaceSuggestion(displayName: 'Parroquia Jesús Nazareno (Villa Brasil)', location: LatLng(8.309220, -62.728110)),
    PlaceSuggestion(displayName: 'Global Stetic Dental (Campo B)', location: LatLng(8.314420, -62.720430)),
    PlaceSuggestion(displayName: 'Conjunto La Alhambra II (Villa Granada)', location: LatLng(8.316440, -62.731600)),
    PlaceSuggestion(displayName: 'Los Enchufados Fast Food (Villa Brasil)', location: LatLng(8.308680, -62.726820)),
    PlaceSuggestion(displayName: 'Laboratorio IMILAB (Campo B)', location: LatLng(8.313990, -62.720180)),
    PlaceSuggestion(displayName: 'Conjunto Las Granadinas (Villa Granada)', location: LatLng(8.311290, -62.731320)),
    PlaceSuggestion(displayName: 'U.E. Colegio Metropolitano', location: LatLng(8.312770, -62.719930)),
    PlaceSuggestion(displayName: 'Abastos La Española (Villa Brasil)', location: LatLng(8.307280, -62.728580)),
    PlaceSuggestion(displayName: 'Centro Quirúrgico Niño Jesús (Campo B)', location: LatLng(8.311130, -62.718210)),
    PlaceSuggestion(displayName: 'Hotel Dos Ríos (Chilemex)', location: LatLng(8.309570, -62.718310)),
    PlaceSuggestion(displayName: 'La Casa Hotel Boutique (Chilemex)', location: LatLng(8.305940, -62.722740)),
    PlaceSuggestion(displayName: 'dbGroup Cocinas (Chilemex)', location: LatLng(8.305300, -62.723100)),
    PlaceSuggestion(displayName: 'Spa Médico Chilemex', location: LatLng(8.304830, -62.723580)),
    PlaceSuggestion(displayName: 'Cocos 286 Heladería (Chilemex)', location: LatLng(8.304470, -62.723280)),
    PlaceSuggestion(displayName: 'EverLogix Mensajería (Chilemex)', location: LatLng(8.304450, -62.723160)),
    PlaceSuggestion(displayName: 'Civeta Café (Chilemex)', location: LatLng(8.304510, -62.722810)),
    PlaceSuggestion(displayName: 'La Izabella Tienda (Chilemex)', location: LatLng(8.304350, -62.723060)),
    PlaceSuggestion(displayName: 'Clínica Chilemex', location: LatLng(8.3012, -62.7185)),
    PlaceSuggestion(displayName: 'Centro Estético Rejuvenecer (Chilemex)', location: LatLng(8.303330, -62.724710)),
    ...
    // --- Alta Vista / Centro de Puerto Ordaz ---
    PlaceSuggestion(displayName: 'Alta Vista Norte', location: LatLng(8.299600, -62.732390)),
    PlaceSuggestion(displayName: 'Banco Nacional de Crédito (Calle Cuchivero)', location: LatLng(8.297550, -62.727680)),
    PlaceSuggestion(displayName: 'BFC Banco (Alta Vista)', location: LatLng(8.297450, -62.727990)),
    PlaceSuggestion(displayName: 'Super Market Alta Vista (Torre Movistar)', location: LatLng(8.297490, -62.728660)),
    PlaceSuggestion(displayName: 'Clínica Sonrisa Total (Alta Vista)', location: LatLng(8.297380, -62.730090)),
    PlaceSuggestion(displayName: 'Dexmo Clínica Dental (Alta Vista)', location: LatLng(8.297110, -62.730040)),
    PlaceSuggestion(displayName: 'Bulldog American Fast Food (Alta Vista)', location: LatLng(8.294490, -62.726230)),
    PlaceSuggestion(displayName: 'Torre A de Alta Vista Suites', location: LatLng(8.294360, -62.726540)),
    PlaceSuggestion(displayName: 'Banplus (Calle Cuchivero, Alta Vista)', location: LatLng(8.295590, -62.733120)),
    PlaceSuggestion(displayName: 'Altavista Beer Company', location: LatLng(8.296020, -62.734650)),
    PlaceSuggestion(displayName: 'Torre B de Alta Vista Suites', location: LatLng(8.294130, -62.726690)),
    PlaceSuggestion(displayName: 'Krosty Burger (Alta Vista)', location: LatLng(8.294170, -62.729660)),
    PlaceSuggestion(displayName: 'Orion Computer I (Alta Vista)', location: LatLng(8.295140, -62.734080)),
    PlaceSuggestion(displayName: 'Bululú Gourmet (Alta Vista)', location: LatLng(8.293830, -62.729710)),
    PlaceSuggestion(displayName: 'Clínica Quirúrgica Razetti (Alta Vista)', location: LatLng(8.295120, -62.734480)),
    PlaceSuggestion(displayName: 'Banco Activo (Paseo Las Américas)', location: LatLng(8.295960, -62.736980)),
    PlaceSuggestion(displayName: 'Banco Nacional de Crédito (Paseo Las Américas)', location: LatLng(8.295890, -62.737190)),
    PlaceSuggestion(displayName: 'La Caribeña Bodegón Alta Vista', location: LatLng(8.293160, -62.731320)),
    PlaceSuggestion(displayName: 'Feminin Tienda de Ropa (Alta Vista)', location: LatLng(8.293520, -62.732780)),
    PlaceSuggestion(displayName: 'Jc Style Shop (Alta Vista)', location: LatLng(8.294610, -62.735860)),
    PlaceSuggestion(displayName: 'Conjunto Residencial Ciudad Jardín', location: LatLng(8.296820, -62.739900)),
    PlaceSuggestion(displayName: 'Globos Domicilios Puerto Ordaz', location: LatLng(8.293640, -62.735130)),
    PlaceSuggestion(displayName: 'La Piazza Restaurante (Alta Vista)', location: LatLng(8.292970, -62.733480)),
    PlaceSuggestion(displayName: 'E/S Alta Vista', location: LatLng(8.294210, -62.736950)),
    PlaceSuggestion(displayName: 'ZOOM Envíos (Alta Vista / Orinokia)', location: LatLng(8.294210, -62.738700)),
    PlaceSuggestion(displayName: 'Perfumería Las Villas (Alta Vista)', location: LatLng(8.294050, -62.738520)),
    PlaceSuggestion(displayName: 'SAREN (Alta Vista)', location: LatLng(8.294140, -62.738880)),
    PlaceSuggestion(displayName: 'Vivero Alta Vista', location: LatLng(8.292410, -62.735780)),
    PlaceSuggestion(displayName: 'Taxis del Orinokia (Plaza Acero)', location: LatLng(8.293830, -62.738730)),
    PlaceSuggestion(displayName: 'Maxi Donas (Alta Vista)', location: LatLng(8.293890, -62.739020)),
    PlaceSuggestion(displayName: 'Plaza Monumental CVG', location: LatLng(8.293030, -62.737660)),
    PlaceSuggestion(displayName: 'EXOTIK (Plaza Santo Tomé, Alta Vista)', location: LatLng(8.293850, -62.739860)),
    PlaceSuggestion(displayName: 'Mr. Sugar (Plaza Caroní)', location: LatLng(8.293510, -62.739360)),
    PlaceSuggestion(displayName: 'PIN Roses Florería (Alta Vista)', location: LatLng(8.293660, -62.739630)),
    PlaceSuggestion(displayName: 'C.C. Alta Vista Gourmet', location: LatLng(8.291160, -62.735120)),
    PlaceSuggestion(displayName: '4D Gelatería (Alta Vista)', location: LatLng(8.293670, -62.740050)),
    PlaceSuggestion(displayName: 'Oporto’s Cafetería (Alta Vista)', location: LatLng(8.291190, -62.735230)),
    PlaceSuggestion(displayName: 'Banesco Plaza Caroní', location: LatLng(8.293080, -62.739530)),
    PlaceSuggestion(displayName: 'Plaza El Eucalipto (Los Samanes)', location: LatLng(8.292070, -62.738390)),
    ...
    // --- Orinokia Mall y Alrededores ---
    PlaceSuggestion(displayName: 'Orinokia Mall (Alta Vista)', location: LatLng(8.292820, -62.741880)),
    PlaceSuggestion(displayName: 'Heladería EFE (Orinokia Mall)', location: LatLng(8.292690, -62.741930)),
    PlaceSuggestion(displayName: 'JUMP Zapatería (Orinokia Mall)', location: LatLng(8.292630, -62.742080)),
    PlaceSuggestion(displayName: 'Victoria’s Secret (Plaza Acero, Orinokia)', location: LatLng(8.292560, -62.742210)),
    PlaceSuggestion(displayName: 'Guess (Plaza Acero, Orinokia Mall)', location: LatLng(8.292390, -62.742030)),
    PlaceSuggestion(displayName: 'Timberland (Plaza Acero, Orinokia)', location: LatLng(8.292360, -62.742090)),
    PlaceSuggestion(displayName: 'Seven’s (Plaza Acero, Orinokia Mall)', location: LatLng(8.292210, -62.742140)),
    PlaceSuggestion(displayName: 'Valeo Sport (Orinokia Mall)', location: LatLng(8.292430, -62.742410)),
    PlaceSuggestion(displayName: 'Kioto Tienda Deportiva (Orinokia)', location: LatLng(8.291920, -62.742630)),
    PlaceSuggestion(displayName: 'MOBY Telefonía (Orinokia Mall)', location: LatLng(8.291900, -62.742790)),
    PlaceSuggestion(displayName: 'Gina Tienda de Ropa (Orinokia Mall)', location: LatLng(8.291880, -62.742930)),
    PlaceSuggestion(displayName: 'Ben Sherman (Plaza Acero, Orinokia)', location: LatLng(8.292380, -62.743160)),
    PlaceSuggestion(displayName: 'Acapulco Ropa (Orinokia Mall)', location: LatLng(8.291810, -62.743160)),
    PlaceSuggestion(displayName: 'Conomania (Plaza Merú, Orinokia)', location: LatLng(8.292170, -62.743270)),
    PlaceSuggestion(displayName: 'Optiglass (Orinokia Mall)', location: LatLng(8.292400, -62.743400)),
    PlaceSuggestion(displayName: 'Banco de Venezuela (Plaza Orinoco, Orinokia)', location: LatLng(8.291640, -62.743340)),
    PlaceSuggestion(displayName: 'Pin Bowl Guayana (Plaza Merú, Orinokia)', location: LatLng(8.292550, -62.743610)),
    PlaceSuggestion(displayName: 'Super Videomania (Plaza Orinoco, Orinokia)', location: LatLng(8.292010, -62.743600)),
    PlaceSuggestion(displayName: 'Outdoors Tienda (Orinokia Mall)', location: LatLng(8.291610, -62.743510)),
    PlaceSuggestion(displayName: 'Cines Unidos (Plaza Merú, Orinokia)', location: LatLng(8.292090, -62.744240)),
    PlaceSuggestion(displayName: 'Anfiteatro del Orinokia', location: LatLng(8.292500, -62.744370)),
    PlaceSuggestion(displayName: 'EPK (Plaza Aluminio, Orinokia)', location: LatLng(8.292760, -62.740590)),
    PlaceSuggestion(displayName: 'Compu Mall (Orinokia Mall)', location: LatLng(8.292610, -62.740940)),
    PlaceSuggestion(displayName: 'Voulez Vous Café (Orinokia)', location: LatLng(8.292740, -62.741000)),
    PlaceSuggestion(displayName: 'Óptica Caroní (Plaza Aluminio, Orinokia)', location: LatLng(8.292920, -62.741120)),
    PlaceSuggestion(displayName: 'Cinnarolls Café (Orinokia Mall)', location: LatLng(8.292880, -62.741360)),
    PlaceSuggestion(displayName: 'McDonald’s Orinokia (Feria OK)', location: LatLng(8.292690, -62.741380)),
    PlaceSuggestion(displayName: 'Arturo’s Express (Feria OK, Orinokia)', location: LatLng(8.292390, -62.741530)),
    PlaceSuggestion(displayName: 'Mexicanito (Feria OK, Orinokia)', location: LatLng(8.292340, -62.741760)),
    PlaceSuggestion(displayName: 'Mario Bros (Feria Orinokia)', location: LatLng(8.2945, -62.7225)),
    PlaceSuggestion(displayName: 'Hemisferios Inmobiliaria (Los Samanes)', location: LatLng(8.291040, -62.741500)),
    PlaceSuggestion(displayName: 'Conjunto Residencial Valeria Suites', location: LatLng(8.290710, -62.741000)),
    PlaceSuggestion(displayName: 'Consulado General de Chile (Los Samanes)', location: LatLng(8.290850, -62.741500)),

    // --- Unare, Los Olivos, Atlántico, UCAB, Unexpo ---
    ...
    PlaceSuggestion(displayName: 'Clínica Familia (Unare)', location: LatLng(8.2865, -62.7495)),
    ...
    // --- Castillito, Parques, Macagua, Ferrominera ---
    ...
    PlaceSuggestion(displayName: 'Colegio Nazaret (Castillito)', location: LatLng(8.3160, -62.7070)),
    ...
    PlaceSuggestion(displayName: 'Teatro Sidor (Centro Cívico)', location: LatLng(8.3160, -62.7090)),
    ...
    PlaceSuggestion(displayName: 'Maternidad Negra Hipólita (San Félix)', location: LatLng(8.3300, -62.6500)),
    ...
    PlaceSuggestion(displayName: 'Av. Dalla Costa (San Félix)', location: LatLng(8.3280, -62.6600)),
    ...
    PlaceSuggestion(displayName: 'Sector El Roble (San Félix)', location: LatLng(8.3390, -62.6520)),
    PlaceSuggestion(displayName: 'Sector Doña Bárbara (San Félix)', location: LatLng(8.3410, -62.6400)),
    PlaceSuggestion(displayName: 'Sector Moreno de Mendoza (San Félix)', location: LatLng(8.3360, -62.6580)),
    PlaceSuggestion(displayName: 'Sector Vista al Sol (San Félix)', location: LatLng(8.3200, -62.6200)),
    PlaceSuggestion(displayName: 'Sector 11 de Abril (San Félix)', location: LatLng(8.3250, -62.6300)),
    PlaceSuggestion(displayName: 'Sector 25 de Marzo (San Félix)', location: LatLng(8.3150, -62.6100)),
    PlaceSuggestion(displayName: 'Sector Manoa (San Félix)', location: LatLng(8.3350, -62.6480)),
    PlaceSuggestion(displayName: 'Sector UD-145 (San Félix)', location: LatLng(8.3300, -62.6550)),
    ...
    PlaceSuggestion(displayName: 'Iglesia San Buenaventura (El Roble, San Félix)', location: LatLng(8.3380, -62.6510)),
    ...
    PlaceSuggestion(displayName: 'Astilleros de Ciudad Guayana (San Félix)', location: LatLng(8.3450, -62.6600)),
    ...
    PlaceSuggestion(displayName: 'C.C. Virgen del Valle (San Félix)', location: LatLng(8.3375, -62.6580)),
    ...
    PlaceSuggestion(displayName: 'Comisaría Guaiparo (San Félix)', location: LatLng(8.3355, -62.6545)),
    PlaceSuggestion(displayName: 'Universidad Bicentenaria de Aragua (UBA) San Félix', location: LatLng(8.3320, -62.6390)),
    PlaceSuggestion(displayName: 'Ferretería EPA (San Félix)', location: LatLng(8.3330, -62.6350)),
    PlaceSuggestion(displayName: 'Distribuidor Redoma El Dorado (San Félix)', location: LatLng(8.3312, -62.6455)),
    ...
    PlaceSuggestion(displayName: 'Escuela Básica Nacional Carlos Enrique Álvarez (Upata)', location: LatLng(8.0175, -62.3920)),
    ...
    PlaceSuggestion(displayName: 'Cerro El Toro (Punto de Ascenso, Upata)', location: LatLng(8.0250, -62.3800)),
  ...
  /// Encuentra el lugar de referencia más cercano de la base de datos si está a menos de 2.5 km
  static String? findNearestDatasetPlace(LatLng location, {double maxRadiusKm = 2.5}) {
